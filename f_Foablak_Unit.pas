...
type
  Tf_Foablak = class(TForm)
    ...
    Mintk1: TMenuItem;
    Szmlzs1: TMenuItem;
    m_egyeniszamla: TMenuItem;
    m_haviszamla: TMenuItem;
    N1: TMenuItem;
    Htralkosok1: TMenuItem;
    Befizetsek1: TMenuItem;
    N2: TMenuItem;
    Kimutatsok1: TMenuItem;
    Beszeds1: TMenuItem;
    Szerzds1: TMenuItem;
    Htralk1: TMenuItem;
    Rszletfizets1: TMenuItem;
    Pnztr1: TMenuItem;
    Bank1: TMenuItem;
    Rszletfizets2: TMenuItem;
    Keresse1: TMenuItem;
    Listja1: TMenuItem;
    Keress1: TMenuItem;
    mogats1: TMenuItem;
    sb_beallitas: TSpeedButton;
    sb_berlemenykereses: TSpeedButton;
    sb_berlokereses: TSpeedButton;
    sb_szerzodes: TSpeedButton;
    sb_szamlakeres: TSpeedButton;
    ...
    procedure sb_berlokeresesClick(Sender: TObject);
    procedure sb_berlemenykeresesClick(Sender: TObject);
    procedure sb_szerzodesClick(Sender: TObject);
    procedure FormClose(Sender: TObject; var Action: TCloseAction);
    procedure sb_szamlakeresClick(Sender: TObject);
    procedure mogats1Click(Sender: TObject);
    procedure Rszletfizets2Click(Sender: TObject);
    procedure Befizetsek1Click(Sender: TObject);
    procedure Laksok1Click(Sender: TObject);
    procedure m_szamlakClick(Sender: TObject);
    procedure Alaphelyzet1Click(Sender: TObject);
    procedure Pnztr1Click(Sender: TObject);
...
procedure Tf_Foablak.Befizetsek1Click(Sender: TObject);
begin
  AblakNyit(Tf_BefizetesSzures, TForm(f_BefizetesSzures));
end;
...
procedure Tf_Foablak.Helyisgek1Click(Sender: TObject);
begin
  AblakNyit(Tf_HelyisegKeres, TForm(f_HelyisegKeres));
end;

procedure Tf_Foablak.m_szamlakClick(Sender: TObject);
begin
  AblakNyit(Tf_SzamlaKeres, TForm(f_SzamlaKeres));
end;

procedure Tf_Foablak.Pnztr1Click(Sender: TObject);
begin
  AblakNyit(Tf_PenztarKeres, TForm(f_PenztarKeres));
end;

procedure Tf_Foablak.Laksok1Click(Sender: TObject);
begin
  AblakNyit(Tf_LakasKeres, TForm(f_LakasKeres));
end;
...
procedure Tf_Foablak.mogats1Click(Sender: TObject);
begin
  AblakNyit(Tf_TamogatasSzures, TForm(f_TamogatasSzures));
end;

procedure Tf_Foablak.Rszletfizets2Click(Sender: TObject);
begin
  AblakNyit(Tf_ReszletfizetesSzures, TForm(f_ReszletfizetesSzures));
end;

procedure Tf_Foablak.sb_adminClick(Sender: TObject);
begin
  AblakNyit(Tf_Admin, TForm(f_Admin));
end;
...
procedure Tf_Foablak.sb_szamlakeresClick(Sender: TObject);
begin
  AblakNyit(Tf_SzamlaKeres, TForm(f_SzamlaKeres));
end;

procedure Tf_Foablak.sb_berlemenykeresesClick(Sender: TObject);
begin
  AblakNyit(Tf_BerlemenyKereses, TForm(f_BerlemenyKereses));
end;

procedure Tf_Foablak.sb_berlokeresesClick(Sender: TObject);
begin
...
procedure Tf_Foablak.sb_szerzodesClick(Sender: TObject);
begin
  AblakNyit(Tf_SzerzodesKeres, TForm(f_SzerzodesKeres));
end;
